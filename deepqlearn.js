...
(function(global) {
  ...
  Brain.prototype = {
    ...
    report: function() {
      var t = [];
      t.push('experience replay size: ' + this.experience.length);
      t.push('exploration epsilon: ' + this.epsilon);
      t.push('age: ' + this.age);
      t.push('average Q-learning loss: ' + this.average_loss_window.get_average());
      t.push('smooth-ish reward: ' + this.average_reward_window.get_average());
      return t;
    }
  }
